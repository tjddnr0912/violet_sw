...
| 다차원 unpacked 배열 부분 슬라이스 (`g[i]`, 차원수보다 적은 인덱스) | `VITA-E3009` loud reject(전 차원 인덱스 필수) | unpacked 배열 슬라이스/whole-array 대입 |
| instance array (`dff u[3:0](...)`) | `VITA-E3009` loud reject(Phase-1.x) | per-instance 포트 슬라이싱 언롤 |
