...
- [ ] **[BLOCKER·P1]** Add `**` (and AShl/AShr) to the compile-time constant evaluator — `parameter = 2**N` silently folds to 0
...
- [ ] **[MAJOR·P1]** Fix casex/casez to treat SCRUTINEE x/z as don't-care (only label-side wildcard implemented)
...
- [ ] **[MAJOR·P1]** Fix out-of-range array WORD index: return X on read / ignore on write (currently clamps to last word) and emit E-RUN-RANGE
