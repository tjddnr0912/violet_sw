...
2. ~~①dirty-list 넷 스캔(R2)~~ ✅ 2026-06-10(NETS_HEAVY 305→15.5ms ≈19.7x — dirty 스윕+snapshot_prev 삭제) · ~~②filelist typed 버킷~~ ✅ 2026-06-10(-D/-I·+define+/+incdir+·WRONG-STAGE·OVERRIDE). **다음 후보:** ③native-eval C6 lane(>64bit/real/array-indexed) ④vita-log 2단계(--log tee·-q/-v·counts epilogue) ⑤intra-assignment delay·force full 재평가·implicit-net ⑥Phase-2 관문(dynamic array/queue/interface — 차기 bump 묶음) ⑦3-OS CI 실구동 ⑧net_to_edge/waiter 자료구조(다넷 스케일링 다음 층) ⑨P4-T2(front-end 병렬).
