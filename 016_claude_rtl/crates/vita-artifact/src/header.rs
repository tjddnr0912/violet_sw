...
pub const CURRENT_FORMAT_VERSION: u32 = 6; // v6 (2026-06-11): +SysFuncId Assoc{First,Next,Last,Prev}, +SysTaskId QInsert/QDeleteIdx, +NetKind AssocStr (string-keyed assoc)
