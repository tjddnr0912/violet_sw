...
/// pipeline.
fn seq_has_clocked(seq: &ast::Sequence) -> bool {
    match seq {
...
fn strip_redundant_clocks(seq: &ast::Sequence, prop_clock: &ast::Sensitivity) -> ast::Sequence {
    match seq {
