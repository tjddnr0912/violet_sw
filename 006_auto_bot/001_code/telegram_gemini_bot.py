...
---
[전제 가드] 위 질문은 '주제·의도'로만 사용한다. 질문에 담긴 전제·가정·수치를 사실로 단정하지 말고,
검색으로 확인되지 않으면 교정하거나 "질문의 전제와 달리 …"로 바로잡아 서술한다.
독자는 원 질문을 보지 못하므로 질문을 인용·되묻지 말고 주제에 대한 독립적·자기완결적 글로 작성한다.
