...
from ver3.config_base import (
    AVAILABLE_COINS,
    POPULAR_COINS,
    MULTI_TF_REGIME_CONFIG as VER2_MULTI_TF_REGIME_CONFIG,
    ...
    ADAPTIVE_WEIGHT_CONFIG as VER2_ADAPTIVE_WEIGHT_CONFIG,
    ORDERBOOK_CONFIG as VER2_ORDERBOOK_CONFIG,
)
...
MULTI_TF_REGIME_CONFIG = VER2_MULTI_TF_REGIME_CONFIG.copy()
...
ADAPTIVE_WEIGHT_CONFIG = VER2_ADAPTIVE_WEIGHT_CONFIG.copy()
ORDERBOOK_CONFIG = VER2_ORDERBOOK_CONFIG.copy()
...
def get_version_config(interval: str = '1h', mode: str = None, coins: List[str] = None) -> Dict[str, Any]:
    ...
    return {
        ...
        'MULTI_TF_REGIME_CONFIG': MULTI_TF_REGIME_CONFIG,
        ...
        'ADAPTIVE_WEIGHT_CONFIG': ADAPTIVE_WEIGHT_CONFIG,
